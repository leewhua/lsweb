class MainView extends egret.DisplayObjectContainer 
{
	...
	private ball1:egret.Bitmap;
	private ball2:egret.Bitmap;
	private ball3:egret.Bitmap;
	private ball4:egret.Bitmap;
	private ball5:egret.Bitmap;

	private txt1:egret.Bitmap;
	private txt2:egret.Bitmap;
	private txt3:egret.Bitmap;
	private txt4:egret.Bitmap;
	private txt5:egret.Bitmap;
	...
	private initView():void
	{
		...
		var logo:egret.Bitmap = AssetsUtils.createBitmapByName("llogo_png");
	...
	private ballClick(evt:egret.TouchEvent):void
	{
		var index = 0;
		if(this.ball1 == evt.currentTarget as egret.Bitmap)
		{
			index = 1;
		}else if(this.ball2 == evt.currentTarget as egret.Bitmap)
		{
			index = 2;
		}else if(this.ball3 == evt.currentTarget as egret.Bitmap)
		{
			index = 3;
		}else if(this.ball4 == evt.currentTarget as egret.Bitmap)
		{
			index = 4;
		}else if(this.ball5 == evt.currentTarget as egret.Bitmap)
		{
			index = 5;
		}
