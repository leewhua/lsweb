...
{
	private btnCopy:egret.Bitmap;

	private btnMarket:egret.Bitmap;
	...
	public txtHb:egret.TextField;

	public txtKq:egret.TextField;

	private iconHb:egret.Bitmap;

	private iconKq:egret.Bitmap;

	public people:CustomImage;

	private btnZhuan:egret.Bitmap;

	private btnZongzi:egret.Bitmap;
	...
	{
		var dai:egret.Bitmap = Global.createBitmapByName("dai1_png");
        ...
        var dai1:egret.Bitmap = Global.createBitmapByName("dai2_png");
        ...
        var dai2:egret.Bitmap = Global.createBitmapByName("dai3_png");
        ...
        var dai3:egret.Bitmap = Global.createBitmapByName("dai4_png");
        ...
        var dai4:egret.Bitmap = Global.createBitmapByName("dai5_png");
        ...
        var dai5:egret.Bitmap = Global.createBitmapByName("dai6_png");
	...
	private zongZiClickHandler():void
	{
		PopManager.showPop("AnswerPop");
	}

	public showShiZi():void
	{
	...
	private kqClickHandler():void
	{
		PopManager.showPop("UserPop",3);
	}

	private shizi:egret.Bitmap;
	...
	private showMask(str,target):void
	{
	...
	private removeJumpShop(id):void
	{
	...
	private isShowGlow = false;

	public static glowFilter = [new egret.GlowFilter(0xffff00,1,5,5,20,1,false,false)];
	...
	private enterFrameHandler():void
	{
		if(this.index % 10 == 0)
		{
			...
			// 	if(this.isShowGlow)
			// 	{
			// 		this.curObject.filters = MainView.nullFilter;
			// 	}else
			// 	{
			// 		this.curObject.filters = MainView.glowFilter;
			// 	}
			// 	this.isShowGlow = !this.isShowGlow;
			// }
		}
	 ...
	 * target 作用域对象
	 */
	public addValue(now,val,target):void
	{
		if(target)
		{
			var len = val - now;
	...
	private activityClickHandler():void
	{
	...
	private marketClickHandler():void
	{
	...
	private postClickHandler():void
	{
		if(MapManager.instance.serverLng)
        {
			MapManager.instance.curMapLevel = 17;
			MapManager.instance.refreshMap();
            // eval("$Gmap.centerAndZoom(new BMap.Point($NowLoct.x, $NowLoct.y), 17);");
            // this.mapView.mapMove();
            // eval("$Gmap.setCenter(new BMap.Point($NowLoct.x, $NowLoct.y));");
        }
	}

	private copyClickHandler():void
	{
		if(this.curGuideID == 1)
		{
			return;
