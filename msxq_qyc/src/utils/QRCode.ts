...
class QRCode{
    ...
    public setPosition(xPos:number, yPos:number, width:number, height:number){
        ...
        if(document.body.clientWidth < document.body.clientHeight){
            var wScale = document.body.clientWidth / StageUtils.SW;
            var hScale = document.body.clientHeight / StageUtils.SH;
        ...
        //横屏
            ...
            var wScale = document.body.clientWidth / StageUtils.SH;
            var hScale = document.body.clientHeight / StageUtils.SW;
            this.htmlCode.style.width =height*wScale + "px";
            this.htmlCode.style.height = width*hScale + "px";
            this.htmlCode.style.top = (StageUtils.SH - xPos -width)*hScale + "px";
