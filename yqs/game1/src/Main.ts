...
class Main extends egret.DisplayObjectContainer {
    ...
    */
    ...
    public static api: string = "http://play.leasiondata.cn/lsplaycity/luck";//"http://lsid.me/luck/play";//"http://leasiondata.cn/luck/play1";//
    public static token: string = "d82cf56540134d6f93fb88d3edf5dc50";
