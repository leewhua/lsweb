...
var ChangePWPop = (function (_super) {
    ...
    ChangePWPop.prototype.show = function () {
    ...
    ChangePWPop.prototype.idFocusInHandler = function () {
        if (this.txtID.text == "请输入用户名") {
            this.txtID.text = "";
        }
    };
    ChangePWPop.prototype.idFocusOutHandler = function () {
        if (this.txtID.text == "") {
            this.txtID.text = "请输入用户名";
        }
    };
    ChangePWPop.prototype.pwFocusInHandler = function () {
    ...
    ChangePWPop.prototype.pwFocusOutHandler = function () {
        if (this.txtPW.text == "") {
            this.txtPW.text = "请输入原密码";
            this.txtPW.displayAsPassword = false;
        }
    ...
    ChangePWPop.prototype.showResult = function (bl) {
