$.shareObj={link:"http://res.leasiondata.cn/lstatic/t/share/index.html",
			imgUrl:"http://res.leasiondata.cn/lstatic/t/share.jpg",
			copy:"码上来战 红包百万"};
$.wxIsReady=false;
$.wxConfig=null;
var loadWx=function(){
	$.ajax({
		...
		data: {type:"getwxconfig",url4wxjssdk:window.location.href.split("#")[0],eid:"t"},//encodeURIComponent
