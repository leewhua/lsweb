 ...
 *
 */
var ShootBar = (function (_super) {
    __extends(ShootBar, _super);
    function ShootBar() {
    ...
    ShootBar.prototype.touchBeginHander = function (e) {
        this.alpha = 0.6;
        this.dispatchEvent(new EventObj('event', 'shoot', true));
    };
    ShootBar.prototype.touchEndHander = function (e) {
        this.alpha = 1;
    };
    return ShootBar;
}(egret.Sprite));
__reflect(ShootBar.prototype, "ShootBar");
//# sourceMappingURL=ShootBar.js.map