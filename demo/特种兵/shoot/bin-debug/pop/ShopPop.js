...
var ShopPop = (function (_super) {
    ...
    function ShopPop() {
        ...
        _this.selectGun = -1;
        _this.offs = [0, 5, 10, 15, 20, 30, 40, 60, 80, 100];
        _this.addEventListener('event', _this.eventHandler, _this);
        return _this;
    }
    ShopPop.prototype.eventHandler = function (event) {
    ...
    ShopPop.prototype.activeOther = function () {
    ...
    ShopPop.prototype.showEnd = function () {
    ...
    ShopPop.prototype.loadListSuccess = function (data) {
    ...
    ShopPop.prototype.show = function (hasDelay) {
