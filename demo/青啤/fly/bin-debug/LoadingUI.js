...
var LoadingUI = (function (_super) {
    ...
    LoadingUI.prototype.createView = function () {
        ...
        this.loadingTxt.width = 640;
        this.loadingTxt.text = "loading...";
        this.loadingTxt.y = 580;
        this.slog = new Middle(Main.createBitmapByName('slog_png'));
        ...
        var tw2 = egret.Tween.get(this.slog);
        this.slog.alpha = 0;
        this.slog.scaleX = this.slog.scaleY = 0.5;
        tw2.wait(200);
        tw2.to({ alpha: 1, scaleX: 0.6, scaleY: 0.6 }, 500, egret.Ease.backOut);
