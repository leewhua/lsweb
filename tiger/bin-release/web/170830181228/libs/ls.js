$.shareObj={link:"http://res.leasiondata.cn/lstatic/r/share.html",
			imgUrl:"http://res.leasiondata.cn/lstatic/r/share.jpg",
			copy:"我拥有这样的能量源！"};
$.wxIsReady=false;
$.wxConfig=null;
var loadWx=function(){
	$.ajax({
		...
		data: {url4wxjssdk:(window.location.href.split("#")[0]), ticket: window.location.href.split("#")[0].split("?")[1].substring(0, 32)},//encodeURIComponent   .split("?")[1].substring(0, 32)
